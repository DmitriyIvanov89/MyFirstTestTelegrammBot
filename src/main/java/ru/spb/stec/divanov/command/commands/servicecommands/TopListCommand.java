...
import ru.spb.stec.divanov.service.controllers.GetTopCoinsRatesController;
...
public class TopListCommand implements Command {
    ...
    public void execute(Update update) {
        sendBotMessageService.sendMessage(update.getMessage().getChatId().toString(),
                new ResponsePrinter().convertResponseToString(new GetTopCoinsRatesController().getRates()));
    }
}
